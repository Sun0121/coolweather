...
import com.example.sun.coolweather.android.gson.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=55a160bda6a849fca706ece7237a987b";
